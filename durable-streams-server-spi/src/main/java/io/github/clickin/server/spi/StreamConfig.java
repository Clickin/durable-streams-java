...
public final class StreamConfig {
    private final io.github.clickin.core.StreamConfig delegate;
    ...
    public StreamConfig(String contentType, Long ttlSeconds, Instant expiresAt) {
        this.delegate = new io.github.clickin.core.StreamConfig(contentType, ttlSeconds, expiresAt);
    }


    public io.github.clickin.core.StreamConfig unwrap() {
        return delegate;
    }

package io.github.clickin.spring.webflux;
...
public final class DurableStreamsWebFluxAdapter {
    ...
    private static io.github.clickin.server.core.ServerRequest toEngineRequest(ServerRequest req, byte[] body) {
        ...
        return new io.github.clickin.server.core.ServerRequest(method, req.uri(), headers, in);
    }

    private Mono<ServerResponse> toWebResponse(io.github.clickin.server.core.ServerResponse response) {
    ...
    private static InputStreamResource openRegionResource(io.github.clickin.server.spi.ReadOutcome.FileRegion region) {
        try {

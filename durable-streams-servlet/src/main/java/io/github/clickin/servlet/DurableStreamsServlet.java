package io.github.clickin.servlet;
...
public final class DurableStreamsServlet extends HttpServlet {
    ...
    private static void writeFileRegion(HttpServletResponse resp, io.github.clickin.server.spi.ReadOutcome.FileRegion region) throws IOException {
